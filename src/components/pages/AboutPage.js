        ...
        return (
            <div className="page-error-wrapper">
                <div>
                    ...
                    <Link to="/">
                        <img src={require('../../images/logo.png')} className="img-fluid" alt="" width="20%" />
                    </Link>
                    </h1>
                        <br />
                        <h5 className="tx-sm-24 tx-normal">Сдай ЕНТ и выиграй стипендию до 200 000 тенге от лучшего образовательного центра страны!</h5>
                        <div className="section-wrapper mg-t-20">
                            <label className="section-title">Информация о конкурсе "UStudy Стипендия"</label>
                            <p className="mg-b-20 mg-sm-b-40">Как участвовать в конкурсе "UStudy Стипендия"</p>
                                    ...
                                    <div className="list-group">
                                        <blockquote className="blockquote bd-l bd-5 pd-l-20">
                                            <footer className="blockquote-footer tx-14">
                                                <p>
                                                    Настоящие правила Конкурса, регулирует правоотношения, возникающие между ТОО «U-FUTURE», юридическим лицом,
                                        <br /> созданным и действующим в соответствии с законодательством Республики Казахстан,
                                        <br />с местом нахождения по адресу: г. Алматы, Ауэзовский район, мкр.Мамыр-4, д.145В,
                                                    «Организатор конкурса» и физическим лицом, «Участник конкурса».
                                    </p>
                                                <hr />
                                                <p>
                                        ...
                                        <div className="list-group-item d-block pd-y-20">
                                            ...
                                            <h6 className="lh-3 mg-b-10">
                                                <a className="tx-inverse hover-primary">на первом этапе проводится комплексное тестирование в виде оффлайн: начинается в 8:00
                                        по местному времени: будет длиться 3 часа 50 минут;</a>
                                            </h6>
                                            <h6 className="lh-3 mg-b-10">
                                                <a className="tx-inverse hover-primary">участники, набравшие выше 50 баллов, автоматически проходят на второй этап;</a>
                                            </h6>
                                            <h6 className="lh-3 mg-b-10">
                                                <a className="tx-inverse hover-primary">второй этап: письменный экзамен по математике состоящий из 5 вопросов, время выполнения
                                        задания: 20 минут; </a>
                                            </h6>
                                        </div>
                                        ...
                                        <div className="list-group-item d-block pd-y-20">
                                            <div className="d-flex justify-content-between align-items-center tx-12 mg-b-10">
                                                <a className="tx-info">6. Также можно пройти пробное тестирование на сайте grant.ustudy.kz , стоимость прохождения
                                        одного тестирования 400 тенге</a>
                                            </div>
                                        </div>
                                        <div className="list-group-item d-block pd-y-20">
                                            <div className="d-flex justify-content-between align-items-center tx-12 mg-b-10">
                                        ...
                                        <div className="list-group-item d-block pd-y-20">
                                            <div className="d-flex justify-content-between align-items-center tx-12 mg-b-10">
                                                <a className="tx-info">12. «Ustudy» переводит деньги на счет ВУЗа выбранного ученика, деньги в течение 9 месяцев
                                        будет перечисляться на банковскую карту ученика; </a>
                                            </div>
                                        </div>
                                        <div className="list-group-item d-block pd-y-20">
                                            <div className="d-flex justify-content-between align-items-center tx-12 mg-b-10">
                                                <a className="tx-info">13. В случае, если ученик не поступить в ВУЗ, выигранные деньги также будет перечисляться
                                        на карточку ученика в виде стипендия в течение 9 месяцев; </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="list-group-item d-block pd-y-20">
                                            <div className="d-flex justify-content-between align-items-center tx-12 mg-b-10">
                                                <a className="tx-info">Для более подробной информации обращаться по номеру: +7 727 356 00 28 или на короткий
                                        номер с мобильного 3560 (бесплатно для всех операторов, кроме Алтел)</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <br />
                        <p className="mg-b-50">
                            <Link to="/" className="btn btn-error">На главную</Link>
                        </p>
                        <p className="error-footer"> &copy; ТОО "U-Partners" 2009-{(new Date()).getFullYear()} Все права защищены.</p>
                </div>
